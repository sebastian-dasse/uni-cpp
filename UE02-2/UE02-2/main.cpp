...
////    auto fp_8_8 = fix_point<8, 8>(12.34f);
////    cout << "fp_8_8: " << float(fp_8_8) << endl;
...
//    float fl1 = -3.0125f;
//    float fl2 = 2.0125f;
//    fix_point<L,R> fp1 = fix_point<L,R>(fl1);
//    fix_point<L,R> fp2 = fix_point<L,R>(fl2);
////    fix_point<L,R> fp1 = fl1;
////    fix_point<L,R> fp2 = fl2;
...
//////    cout << float(pow(fix_point<L,R>(2.f), -4)) << endl;
//////    cout << endl;
////    cout << float(fix_point<L,R>(17.f) % fix_point<L,R>(5.f)) << endl;
////    cout << endl;
////    cout << floor(fix_point<L,R>(12.34f)) << endl;
////    cout << frac(fix_point<L,R>(12.34f)) << endl;
////    cout << float(fix_point<L,R>(2.f).pow(8)) << endl;
////    cout << float(fix_point<L,R>(2.f).pow(0)) << endl;
////    cout << float(fix_point<L,R>(2.f).pow(-8)) << endl;
////    cout << endl;
